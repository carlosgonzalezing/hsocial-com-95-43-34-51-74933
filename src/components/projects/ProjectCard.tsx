    ...
    >
      ...
      <div className="relative aspect-[16/9] bg-gradient-to-br from-primary/10 via-primary/5 to-background overflow-hidden">
        ...
        <div className="absolute top-3 left-3">
          <Badge 
            className={`${statusConfig.color} text-white font-bold px-4 py-2 text-xs uppercase tracking-wide shadow-lg backdrop-blur-sm`}
          >
            {statusConfig.label}
          </Badge>
        </div>
        ...
        {project.seeking_collaborators && (
          <div className="absolute top-3 right-3">
            <Badge className="bg-emerald-500 text-white font-bold px-4 py-2 text-xs shadow-lg backdrop-blur-sm">
              🤝 Busca colaboradores
            </Badge>
          </div>
        )}
      ...
      {/* Content - More spacious and organized */}
      <div className="p-6 space-y-5">
        ...
        {/* Author and Stats - Premium layout */}
